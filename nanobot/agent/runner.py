...
# NOTE: ContextGovernor currently microcompacts using its own fixed
# MICROCOMPACT_KEEP_RECENT / MICROCOMPACT_MIN_CHARS constants rather than
# reading RunnerLimits; these two defaults keep the historical values so the
# (still-public/configurable) RunnerLimits fields below don't silently
# regress, but overriding them has no effect until ContextGovernanceConfig
