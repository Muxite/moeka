...
async def test_start_webhook_mode(monkeypatch) -> None:
    ...
    assert app.updater.start_webhook_kwargs == {
        ...
        # moeka: drop_pending_updates defaults to True (see
        # TelegramConfig.drop_pending_updates) to avoid stale-update floods
        # on restart; the config here doesn't override it.
